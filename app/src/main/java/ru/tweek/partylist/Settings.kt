...
class Settings : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.descriptionShow.isChecked = viewModel.showdescription
        binding.descriptionShow.setOnCheckedChangeListener { _, isChecked ->
            viewModel.showdescription = isChecked
        }
